@echo off
REM ----------------------------------------------------------------------
REM Structra - Test Runner for test_logger_config.py
...
REM Running test_logger_config.py with coverage
echo Running test_logger_config.py with coverage...
coverage run --source=structra -m unittest tests.test_logger_config
coverage report -m
